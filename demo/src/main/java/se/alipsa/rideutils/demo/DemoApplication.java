package se.alipsa.rideutils.demo;
...
public class DemoApplication extends Application {
  static Logger log = LogManager.getLogger(DemoApplication.class);
  Stage stage;
  TextArea outputTa;
  ...
  public void start(Stage stage) {
    ...
    demoFiles.setConverter(new StringConverter<>() {
      @Override
    ...
    Task<Void> task = new Task<>() {
      ...
      public Void call() throws Exception {
        try (AppenderPrintWriter out = new AppenderPrintWriter();
          ...
          engine.put("inout", DemoApplication.this);
          engine.eval(rCode);
